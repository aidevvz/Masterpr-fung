...
const STORAGE_KEY = "immolotse_fc_v5";
...
const flashcards = {
  ...
  "Innovationsmanagement": [
    ...
    { id:"I10", q:"Was ist Disruptive Innovation (Christensen)?", desc:"Clayton Christensen: Innovationen die klein starten, billiger/einfacher sind und die Etablierten verdrängen.", a:"Inkrementell: kleine Verbesserung (neue iPhone-Kamera)\nRadikal: komplett neue Technologie (erstes Smartphone)\nDisruptiv: startet schlechter/billiger, wird besser, verdrängt alles!\n\nAblauf:\n1. Neues Produkt schlechter aber billiger\n2. Etablierte ignorieren es\n3. Wird immer besser\n4. Plötzlich gut genug für alle — Alte zu langsam\n\nBeispiele: Netflix → Blockbuster, Spotify → CDs\nImmolotse = disruptiv für Maklerbranche!" },
    { id:"I11", q:"Was ist der Unterschied POC vs. Prototyp vs. MVP?", desc:"3 aufeinanderfolgende Stufen vor dem fertigen Produkt — oft verwechselt!", a:"POC (Proof of Concept): Funktioniert es technisch? Sieht hässlich aus, nur intern.\n\nPrototyp: Ist es bedienbar? Sieht aus wie Produkt, läuft aber noch nicht vollständig.\n\nMVP (Minimum Viable Product): Will es jemand kaufen? Echtes Produkt, echte Kunden, nur Kernfunktionen.\n\nMerksatz: POC = technisch möglich? Prototyp = bedienbar? MVP = will jemand zahlen?" },
  ],
  ...
  "Strategic Marketing": [
    ...
    { id:"M11", q:"Was sind Marktpotenzial, Marktvolumen und Marktanteil?", desc:"3 Begriffe zur Marktgröße — oft verwechselt! Formel für Marktanteil ist prüfungsrelevant.", a:"Marktpotenzial: theoretische Obergrenze (wenn alle kaufen würden)\nMarktvolumen: was tatsächlich verkauft wird\nAbsatzpotenzial: was ich realistisch verkaufen könnte\nMarktanteil: (eigener Umsatz / Gesamtumsatz) × 100\n\nBeispiel E-Autos Österreich:\nPotenzial = 5 Mio. Führerscheinbesitzer\nVolumen = 30.000 E-Autos/Jahr\nTesla Marktanteil = 6.000/30.000 × 100 = 20%\n\nMerksatz: Potenzial = Theorie. Volumen = Realität. Marktanteil = mein Anteil." },
    { id:"M12", q:"Was ist Porters Diamantenmodell?", desc:"Michael Porter: Erklärt warum bestimmte Branchen in bestimmten Ländern weltweit führend sind.", a:"4 Faktoren:\n1. Faktorenbedingungen — Was hat das Land zu bieten? (Alpen → Skitourismus)\n2. Nachfragebedingungen — Wie anspruchsvoll sind heimische Kunden?\n3. Verwandte & unterstützende Branchen — Starke Zulieferer?\n4. Unternehmensstruktur & Wettbewerb — Intensiver Heimwettbewerb?\n\n+ 2 externe Faktoren: Zufall & Staat\n\nMerksatz: Anspruchsvolle Kunden + starke Konkurrenz + gute Ressourcen + starke Zulieferer = Weltklasse!" },
  ],
  "Design Thinking": [
  ...
  "Personal & Teams": [
    ...
    { id:"P11", q:"Was sind die 5V nach Huber (Führungsmodell)?", desc:"Die 5 wichtigsten Eigenschaften einer guten Führungskraft nach Huber.", a:"V1 — Vision: klare Vorstellung wohin die Reise geht\n(Elon Musk: Wir bringen Menschen zum Mars)\n\nV2 — Vertrauen: gegenseitiges Vertrauen\n\nV3 — Verständnis: versteht Probleme & Bedürfnisse der Mitarbeiter\n\nV4 — Vorbildwirkung: lebt vor was er erwartet\n(Jobs arbeitete selbst bis tief in die Nacht)\n\nV5 — Verantwortung: übernimmt Verantwortung auch wenn etwas schiefgeht\n\nMerksatz: Vision zeigt wohin. Vertrauen verbindet. Verständnis menschelt. Vorbildwirkung überzeugt. Verantwortung hält zusammen." },
  ],
  "Teams & Organisation": [
  ...
  "Rechnungswesen": [
    ...
    { id:"RW9", q:"Was sind die 3 Abschreibungsarten (AfA)?", desc:"AfA = Absetzung für Abnutzung. Verteilung der Anschaffungskosten auf die Nutzungsdauer.", a:"Linear: gleichmäßig pro Jahr\nFormel: Anschaffungskosten / Nutzungsdauer\nBeispiel: Auto 30.000€, 6 Jahre → 5.000€/Jahr\n\nDegressiv: am Anfang mehr, dann weniger\nFixer % vom Restwert. Realistischer (Auto verliert im 1. Jahr am meisten)\nBeispiel: 30.000€, 30% → Jahr 1: 9.000€, Jahr 2: 6.300€...\n\nAußerplanmäßig: bei unerwarteten Wertverlusten\nBeispiel: Laptop 2.000€, Restwert 1.000€, dann kaputt → sofort 1.000€ abschreiben\n\nMerksatz: Linear = gleichmäßig. Degressiv = fallend. Außerplanmäßig = Notfall." },
    { id:"RW10", q:"Was sind die Buchführungsschwellenwerte?", desc:"Ab wann brauchen Einzelunternehmen und Personengesellschaften eine Bilanz statt EAR?", a:"Kapitalgesellschaften (GmbH, FlexCo, AG): IMMER Bilanzpflicht!\n\nEinzelunternehmen & Personengesellschaften:\nNormalerweise EAR — ABER Bilanzpflicht wenn:\n\n• Umsatz in ZWEI aufeinanderfolgenden Jahren über 700.000€\n• Umsatz EINMALIG in einem Jahr über 1.000.000€\n\nBeispiel: OG macht 2023 und 2024 je 800.000€ → Bilanzpflicht ab 2025\nBeispiel: OG macht 2023 einmalig 1.100.000€ → Bilanzpflicht ab 2024\n\nMerksatz: Kapitalgesellschaft = immer Bilanz. Personengesellschaft = EAR, außer 700k/2 Jahre oder 1 Mio. einmalig." },
    { id:"RW11", q:"Was sind Rückstellungen — und was ist der Unterschied zur Verbindlichkeit?", desc:"Rückstellungen stehen auf der PASSIVA-Seite (Fremdkapital) — aber sind kein sicheres Datum.", a:"Rückstellung = Schuld die ich heute schon weiß, aber Betrag/Zeitpunkt ungewiss\n\nBeispiele:\n• Prozesskosten (Klage läuft noch)\n• Urlaubsrückstellung (noch nicht verbrauchte Urlaubstage)\n• Garantierückstellung (erfahrungsgemäß 5% Reklamationen)\n\nUnterschied:\n           Verbindlichkeit    Rückstellung\nBetrag:    genau bekannt       ungewiss\nZeitpunkt: bekannt             ungewiss\nBeispiel:  Lieferantenrechnung laufender Prozess\n\nMerksatz: Rückstellung = ich weiß DASS ich zahlen muss, aber nicht WANN und WIE VIEL." },
  ],
};
